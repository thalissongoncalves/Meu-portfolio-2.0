const projectsData = [
    ...
    },
    {
        id: "03",
        display: "block",
        title: "03 - Zuck Challenge",
        description: "Foi desenvolvido uma página falando sobre uma solução que atende ao problema de pessoas daltônicas, onde o projeto consiste em a pessoa fazer alguns testes e descobrir se é daltônica ou não, ou seja esse projeto em si foi criado uma página para apresentação do projeto 'Visual Daltônico'.",
        technologies: ["HTML", "CSS", "JAVASCRIPT"],
        githubUrl: "https://github.com/thalissongoncalves/03-Zuck-Challenge",
